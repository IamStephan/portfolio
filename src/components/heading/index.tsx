...
type TFontSIzes = "xl" | "lg" | "md" | "sm" | "xs";
type TElements = "h1" | "h2" | "h3" | "h4" | "h5" | "h6";
 ...
 *
 * TODO: Maybe add a xl sixing variant?
 *
 */
...
const Heading: React.FC<Props> = ({
  ...
  return (
    <Element
      className={clsx("font-bold font-heading", fontSize, className)}
      {...rest}
    >
      {children}
    </Element>
